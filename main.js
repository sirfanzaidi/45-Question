...
let quote = "Three can keep a secret, if two of them are dead.";
...
const myTransport = ["Mira", "Mehran", "BMW", "porche", "Aqua"];
...
let places = ["Canada", "Australia", "Ireland", "Thailand"];
let original_Erray = places.slice();
...
let Language = ["English", "Urdu", "Farsi", "Punjabi"];
...
let Brother = ["Furqan", "Irfan", "Imran", "Rizwan", "Farhan"];
Brother.slice();
...
console.log(number1 > 50 || number2A > 60);
let Alphbate = ["A", "B", "C", "D", "E"];
Alphbate.map((item => { console.log(item == "E"); }));
let number21 = "50";
...
alienCoulors = "red";
if (alienCoulors === "red") {
    console.log("you just earn 15 Points for shooting the alien.");
}
else {
    console.log("you just earn 10 Points for shooting the alien.");
}
...
else if (age > 2.1 && age < 3.9) {
    console.log("the person is a toddler");
}
else if (age > 4.1 && age < 12.9) {
    console.log("the person is a kid");
}
else if (age > 13.1 && age < 19.9) {
    console.log("the person is a teenager");
}
else if (age > 20.1 && age < 64.9) {
...
let favourite_fruits = ["banana", "Muango", "Melon", "Apple", "Grapes"];
if (favourite_fruits.includes("banana")) {
    console.log("really like bananas!");
}
if (favourite_fruits.includes("Muango")) {
    console.log("really like Muango!");
}
if (favourite_fruits.includes("Muango")) {
    console.log("really like Muango!");
}
if (favourite_fruits.includes("Melon")) {
    console.log("really like Melon!");
}
...
let user_name = ["Admin", "Furqan", "Imran", "Rizwan", "Farhan", "irfan"];
...
let user_names = ["Admin", "Furqan", "Imran", "Rizwan", "Farhan", "irfan"];
user_names = [];
if (user_names.length > 0) {
    ...
    console.log(`${user_names} we need to find some new users.`);
}
...
new_users.forEach((New_one_users => {
    ...
    if (our_coundition) {
        ...
        console.log(`the Usser ${New_one_users} is available`);
    }
}));
...
function make_shirt11(label, size = `Medium`) {
    return `${label} ${size}`;
}
let functionnew1 = make_shirt11(`i love typescript`);
console.log(functionnew1);
function make_shirt12(label, size = `small`) {
    return `${label} ${size}`;
}
...
console.log(album2);
console.log(album3);
function make_album1(artistname, albumtitle, numerofTrack) {
...
let magiciansName = ["Zaid", "Rumaisa", "Mohib", "Ghufran", "Zayan"];
...
let magiciansNames = ["Zaid", "Rumaisa", "Mohib", "Ghufran", "Zayan"];
...
let magiciansNames2 = ["Zaid", "Rumaisa", "Mohib", "Ghufran", "Zayan"];
...
const myCar2 = createCar("Honda", "125", { color: "black", Speed: "fast" });
console.log(myCar);
console.log(myCar2);
